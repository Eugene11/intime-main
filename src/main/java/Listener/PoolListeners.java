...
import Transport.TransportCreator;
...
//				QueueTr.getQueueListenerToProcess().Initialize(paramsQueueListenerToProcess);
//				m_Items.get(i).setQueueTr(QueueTr.getQueueListenerToProcess());
			}
		}
		else
			throw new Exception();
